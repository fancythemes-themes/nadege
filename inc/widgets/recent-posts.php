<?php
/**
 * Widget API: Nadege_Widget_Recent_Posts class
 *
 * @package Nadege
 * @since 1.0.0
 */
 ...
 * @see WP_Widget
 */
class Nadege_Widget_Recent_Posts extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			...
			'description' => esc_html__( "Your site&#8217;s most recent Posts.", 'nadege'),
			'customize_selective_refresh' => true,
		 );
		parent::__construct('nadege-recent-posts', esc_html__('Nadege - Recent Posts', 'nadege'), $widget_ops);
...
?>
		<p><label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php esc_html_e( 'Title:', 'nadege' ); ?></label>
		<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo $title; ?>" /></p>

		<p><label for="<?php echo $this->get_field_id( 'category' ); ?>"><?php esc_html_e( 'Category:', 'nadege' ); ?></label>
			<?php wp_dropdown_categories( 
					array (
						'show_option_all' => esc_html__('All Categories', 'nadege'),
		...
		<p><label for="<?php echo $this->get_field_id( 'tags' ); ?>"><?php esc_html_e( 'Tags:', 'nadege' ); ?></label>
		<input class="widefat" id="<?php $this->get_field_id( 'tags' ); ?>" name="<?php echo $this->get_field_name( 'tags' ); ?>" type="text" value="<?php echo $tags; ?>" />
		</p>

		<p><label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php esc_html_e( 'Number of posts to show:', 'nadege' ); ?></label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'presentation' ) . '-2'; ?>"><?php esc_html_e( 'Small thumbnail', 'nadege'); ?></label><br>
			...
			<label for="<?php echo $this->get_field_id( 'presentation' ) . '-3'; ?>"><?php esc_html_e( 'Image Overlay', 'nadege'); ?></label><br>
			...
			<label for="<?php echo $this->get_field_id( 'is_slider' ); ?>"><?php esc_html_e( 'Show as slider', 'nadege'); ?></label><br> 

			<span class="slider-options">
				<input type="checkbox" id="<?php echo $this->get_field_id( 'slideshow' ); ?>" name="<?php echo $this->get_field_name( 'slideshow' ); ?>" value="slideshow" <?php checked( $slideshow, 'slideshow'); ?> /><label for="<?php echo $this->get_field_id( 'slideshow' ); ?>"><?php esc_html_e('Slideshow', 'nadege'); ?></label><br>
				<label for="<?php echo $this->get_field_id( 'slideshow_time' ); ?>"><?php esc_html_e( 'Slideshow time:', 'nadege' ); ?></label><br>
				...
				<?php esc_html_e('in seconds', 'nadege'); ?><br>
			</span>
		</p>
<?php
	}
...
function nadege_widget_recent_posts() {
	return register_widget("Nadege_Widget_Recent_Posts"); 
}
add_action('widgets_init', 'nadege_widget_recent_posts');
